  ...
  namespace common {
    ...
    struct interval {
      ...
      inline __both__ interval() 
        : lower(mini::common::empty_bounds_lower<T>()),
          upper(mini::common::empty_bounds_upper<T>())
      {}
      ...
      {
        return interval<T>(0.f,mini::common::open_range_upper<T>());
      }
    };
    ...
    struct box_t {
      ...
      inline __both__ box_t()
        : lower(mini::common::empty_bounds_lower<typename T::scalar_t>()),
          upper(mini::common::empty_bounds_upper<typename T::scalar_t>())
      {}
      ...
      { return mini::common::volume(size()); }
